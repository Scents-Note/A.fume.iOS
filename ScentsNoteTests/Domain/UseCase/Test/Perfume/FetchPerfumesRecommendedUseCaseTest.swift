//
//  FetchPerfumesRecommendedUseCaseTest.swift
//  ScentsNoteTests
//
...
final class FetchPerfumesRecommendedUseCaseTest: XCTestCase {
  ...
  override func setUpWithError() throws {
    ...
    self.fetchPerfumesRecommendedUseCase = DefaultFetchPerfumesRecommendedUseCase(perfumeRepository: MockPerfumeRepository())
  ...
  func testExecute_fetchPerfumesRecommended() throws {
