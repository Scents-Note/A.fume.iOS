//
//  FetchPerfumesNewUseCaseTest.swift
//  ScentsNoteTests
//
...
final class FetchPerfumesNewUseCaseTest: XCTestCase {
  ...
  override func setUpWithError() throws {
    ...
    self.fetchPerfumesNewUseCase = DefaultFetchPerfumesNewUseCase(perfumeRepository: MockPerfumeRepository())
  ...
  func testExecute_fetchPerfumesNew() throws {
    ...
    .subscribe(onNext: { [weak self] in
      self?.fetchPerfumesNewUseCase.execute(size: 11)
