//
//  DefaultFetchFilterBrandInitialUseCase.swift
//  ScentsNote
//
...
protocol FetchFilterBrandInitialUseCase {
  func execute() -> Observable<[FilterBrandInitial]>
}

final class DefaultFetchFilterBrandInitialUseCase: FetchFilterBrandInitialUseCase {
